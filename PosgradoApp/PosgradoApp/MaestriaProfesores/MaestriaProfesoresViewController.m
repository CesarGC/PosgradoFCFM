...
- (IBAction)selectedTypeProfesor:(id)sender {
    ...
    if([control selectedSegmentIndex] == 0) {
        ...
        self.arregloProfesores = [[NSMutableArray alloc] initWithArray:@[@{@"profesor":@"Dr. Edgar Martínez Guerra"},@{@"profesor":@"Dr. Javier Fco. Almaguer  Martínez"},@{@"profesor":@"Dr. Joel  Pérez Padrón"},@{@"profesor":@"Dr. Jorge Luis Menchaca Arredondo"},@{@"profesor":@"Dr. Manuel García Méndez"},@{@"profesor":@"Dr. María Aracelia Alcorta García"},@{@"profesor":@"Dr. Miguel Ángel Gracia Pinilla"},@{@"profesor":@"Dr. Omar González Amezcua"},@{@"profesor":@"Dr. Sergio Belmares Perales"}]];
    }
    [self.tablaProfesores reloadData];
}

...
@interface DoctoradoRequisitosViewController () <UIScrollViewDelegate>

@property (weak, nonatomic) IBOutlet UILabel *lblRequisitos;
@property (weak, nonatomic) IBOutlet UIScrollView *scrollDoctorado;
...
@implementation DoctoradoRequisitosViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.scrollDoctorado.delegate = self;
